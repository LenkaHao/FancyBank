 ...
 * Author: Jiatong Hao
 *
 * This class represents a tab that shows info and get user action on a saving account.
 */
...
public class SavingAccountPanel extends JPanel {
    ...
    public SavingAccountPanel(Customer customer, SavingAccount account, EventValidator eventValidator) {
        ...
        JLabel accountDescription = new JLabel("Saving Account #" + account.getAccountNumber());
